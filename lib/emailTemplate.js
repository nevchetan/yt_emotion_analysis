              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td width="33%" align="center" style="padding: 15px; background-color: #ecfdf3; border-radius: 8px; border-left: 4px solid #10b981;">
                    <div style="font-size: 12px; color: #6b7280; margin-bottom: 8px;">Top Sentiment</div>
          ...
          <tr>
            <td style="padding: 20px; background-color: #f3f4f6; text-align: center;">
              <p style="margin: 0; color: #6b7280; font-size: 12px;">
                This is an automated email from YouTube Sentiment Analysis
              </p>
...
⭐ Top Sentiment: ${topEmotion?.emotion || "N/A"} (${topEmotion?.percentage || 0}%)
